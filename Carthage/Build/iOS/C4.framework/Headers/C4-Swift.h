...
- (UIRotationGestureRecognizer * _Nonnull)addRotationGestureRecognizer:(void (^ _Nonnull)(double rotation, double velocity, UIGestureRecognizerState state))action;
...
///
/// <code>let v = View(frame: Rect(0,0,100,100))
...
///
/// <code>let ap = AudioPlayer("audioTrackFileName")
/// 
/// </code>
...
/// 
/// </code>
/// \param channel The audio channel whose average power value you want to obtain.
///
...
- (void)captureImage;
- (void)didCaptureImage:(void (^ _Nonnull)(void))action;
@end
...
/// 
/// </code>
@property (nonatomic, readonly, strong) UIFont * _Nonnull uiifont;

/// Initializes a new Font using the specified font name and size.
///
/// <code>let f = Font("Helvetica", 20)
/// 
/// </code>
/// \param name The name of the font.
///
/// \param size The point-size of the font.
- (nullable instancetype)initWithName:(NSString * _Nonnull)name size:(double)size OBJC_DESIGNATED_INITIALIZER;

/// Initializes a new Font using the specified font name and default size of 12.0 pt.
///
/// <code>let f = Font("Helvetica")
/// 
/// </code>
/// \param name The name of the font
...
+ (NSArray * _Nonnull)familyNames;

/// Returns an array of font names available in a particular font family.
///
/// <code>for n in Font.fontNames("Avenir Next") {
///     println(n)
/// }
/// 
/// </code>
...
+ (NSArray * _Nonnull)fontNames:(NSString * _Nonnull)familyName;

/// Returns the font object used for standard interface items in the specified size.
///
/// <code>let f = Font.systemFont(20)
/// 
/// </code>
/// \param size The size (in points) to which the font is scaled.
///
/// \returns  A font object of the specified size.
+ (Font * _Nonnull)systemFont:(double)size;

/// Returns the font object used for standard interface items that are rendered in boldface type in the specified size.
///
/// <code>let f = Font.boldSystemFont(20)
/// 
/// </code>
/// \param size The size (in points) to which the font is scaled.
///
/// \returns  A font object of the specified size.
+ (Font * _Nonnull)boldSystemFont:(double)size;

/// Returns the font object used for standard interface items that are rendered in italic type in the specified size.
///
/// <code>let f = Font.italicSystemFont(20)
/// 
/// </code>
/// \param size The size (in points) to which the font is scaled.
///
/// \returns  A font object of the specified size.
+ (Font * _Nonnull)italicSystemFont:(double)size;

/// Returns a font object that is the same as the receiver but which has the specified size instead.
///
/// <code>let f = Font(name: "Avenir Next")
/// let f2 = f.font(20)
/// 
/// </code>
/// \param size The desired size (in points) of the new font object.
///
/// \returns  A font object of the specified size.
- (Font * _Nonnull)font:(double)size;
...
@property (nonatomic, readonly) CGFontRef _Nullable CGFont;

/// Returns a CTFontRef version of the receiver.
@property (nonatomic, readonly) CTFontRef _Nonnull CTFont;
@end
...
- (id <CAAction> _Nullable)actionForKey:(NSString * _Nonnull)key;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
/// Initializes a new Image using the specified filename from the bundle (i.e. your project), it will also grab images from the web if the filename starts with http.
///
/// <code>let img = Image("logo")
/// canvas.add(img)
/// 
/// </code>
...
/// Initializes a new Image using the specified filename from the bundle (i.e. your project), it will also grab images from the web if the filename starts with http.
///
/// <code>let img = Image("http://www.c4ios.com/images/logo@2x.png", scale: 2.0)
/// canvas.add(img)
/// 
/// </code>
/// \param name The name of the image included in your project, or a web address.
...
/// Initializes a new Image using a CIImage. Use this method if you're working with the output of a CIFilter.
///
/// \param ciimage A CIImage object.
- (nonnull instancetype)initWithCiimage:(CIImage * _Nonnull)ciimage;

/// Initializes a new Image using a CIImage, with option for specifying the scale of the image. Use this method if you're working with the output of a CIFilter.
///
/// \param ciimage A CIImage object.
///
/// \param scale The scale of the image.
...
/// Initializes a new Image using raw data. Use this if you download an image as data you can pass it here to create an image. See the body of init(url:) to see how to download an image as data.
///
/// \param data An NSData object.
- (nonnull instancetype)initWithData:(NSData * _Nonnull)data;

/// Initializes a new Image using raw data, with option for specifying the scale of the image. Use this if you download an image as data you can pass it here to create an image. See the body of init(url:) to see how to download an image as data.
///
/// \param data An NSData object.
///
/// \param scale The scale of the image.
...
- (void)reachedEnd:(void (^ _Nonnull)(void))action;
@end
...
/// 
/// </code>
/// \param token A token returned from a call to <code>on(event:run:)
/// </code> method
...
/// path.
///
/// <code>let f = Rect(100,100,100,100)
...
@property (nonatomic, copy) void (^ _Nullable previewFinishedAction)(NSSet<NSString *> * _Nullable activities);
...
/// Creates a flattened image of the receiver and its subviews / layers. This override takes into consideration the lineWidth of the receiver.
///
/// \returns  A new Image
- (Image * _Nullable)render;
@end
...
/// A boolean value that, when true, prevents the animation of a shape's properties.
///
/// <code>ShapeLayer.disableActions = true
/// circle.fillColor = red
...
@property (nonatomic, strong) Font * _Nonnull font;

/// Initializes a new TextShape from a specifed string and a font
///
/// <code>let f = Font(name:"Avenir Next", size: 120)
...
- (nullable instancetype)initWithText:(NSString * _Nonnull)text font:(Font * _Nonnull)font;

/// Initializes a new TextShape from a specifed string, using C4's default font.
///
/// <code>let t = TextShape(text:"C4")
/// t.center = canvas.center
/// canvas.add(t)
/// 
/// </code>
...
@property (nonatomic, copy) void (^ _Nullable rotationAction)(double rotation, double velocity, UIGestureRecognizerState state);
@end
